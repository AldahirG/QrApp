  ...
  const handleBarCodeScanned = async ({ data }) => {
    ...
    try {
      ...
      const getResponse = await fetch(
        `${BASE_URL}/api/registros/get/${data}?conferencista=${encodeURIComponent(conferencista)}`
      );
      if (!getResponse.ok) {
      ...
      const updateResponse = await fetch(
        `${BASE_URL}/api/registros/update/${data}?conferencista=${encodeURIComponent(conferencista)}`,
        {
          method: 'PUT',
